...
class DAQ_Move_ForBeginner(DAQ_Move_base):
    """
    ...
    def __init__(self, parent=None, params_state=None):
        ...
        super(DAQ_Move_ForBeginner, self).__init__(parent, params_state)
    ...
    def check_position(self):
        ...
        pos=(self.current_position-self.target_position)*numpy.exp(-dt/self.settings.child('tau').value())+self.target_position




        #pos=self.current_position+(self.target_position-self.current_position)/self.settings.child('tau').value()
